...
#### 2. Top 50 주요 국적 비중
* Top 50 선수들의 국적 데이터를 분석하여, 전 세계 축구 인재의 주요 공급처와 국가별 강세를 파악했습니다. 도넛 차트를 통해 시각적 직관성을 높였습니다.
![Top 50 주요 국적](./top_50_nations.png)

#### 3. 나이 대비 몸값 상관관계 (Aging Curve)
* 상위 8인의 데이터를 바탕으로 나이와 몸값의 상관관계를 분석했습니다. 텍스트 겹침을 최소화하여 각 선수의 데이터 포인트를 명확히 식별할 수 있도록 구성했습니다.
